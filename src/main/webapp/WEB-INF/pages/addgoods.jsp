...
<div class="container">
    <div class="contact">
        ...
        <div class="col-md-6 contact-top">
            ...
            <p>感觉很高端的介绍文字：At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas </p>
        ...
        <div class="col-md-6 contact-top">
            <h3>加入商品</h3>
            <form action="goods/fileupload?uid=${cartcount.uid}" method="post" enctype="multipart/form-data">
                <div>
                    <span>商品名称 </span>
                    <input type="text" value="" name="goodsname">
                </div>
                <div>
                    <span>商品价格 </span>
                    <input type="text" value="" name="goodsprices" >
                </div>
                <div>
                    <span>商品类型</span>
                ...
                <div>
                    <span>生产厂商</span>
                    <input type="text" value="" name="firmname">
                </div>
                <span>选择文件：<input type="file" name="upload" /><br/></span>
