...
<div class="container">
    <h2 class=" products-in" style="padding-top: 3em">所有商品</h2>
    <div class="shopping_cart">
        <c:forEach items="${goodslist}" var="goods" >
            <div class="cart_box">
                <div class="message">
                    <a href="goods/deletegood?uid=${cartcount.uid}&goodsid=${goods.goodsid}"> <div class="alert-close"> </div></a>
                    <div class="list_img"><img src=" ${goods.pictersrc}" class="img-responsive" alt=""></div>
                    <div style="float:left;width:40%;padding-top: 2%"><h4 style="color:#000 !important;
	font-size:12px !important;
	text-decoration:none;
	font-weight:400;
	text-transform:uppercase;
	padding: 1em 0 !important;"><a href="#">${goods.goodsname}</a></h4>
                            <%--${goods.num} x<span class="actual">
		                             ￥${goods.goodsprices}</span>--%>
...
<%--                    <div style="float:left;width:10%;padding-top: 2%;padding-right: 5%"><h4 style="color:#000 !important;
	...
	padding: 1em 0 !important;"><a href="#">金额 ：</a></h4><span class="actual">
          ...
          <%--          <div align="left" style="padding-top: 5%">购买日期 ：<fmt:formatDate value="${orderslist.orderstime}" pattern="yyyy年MM月dd日HH点mm分ss秒" /></div>--%>
                    <div class="clearfix"></div>
                </div>
            </div>
