...
<div class="container">
    <h2 class=" products-in" style="padding-top: 3em">购物车</h2>
    <div class="shopping_cart">
        <c:forEach items="${cartlist}" var="cart" >
            <div class="cart_box">
                <div class="message">
                    <a href="cartdetail/deletegood?uid=${cart.uid}&goodsid=${cart.goodsid}"> <div class="alert-close"> </div></a>
                    <div class="list_img"><img src=" ${cart.pictersrc}" class="img-responsive" alt=""></div>
	...
	padding: 1em 0 !important;"><a href="#">${cart.goodsname}</a></h4>${cart.num} x<span class="actual">
		                             ￥${cart.goodsprices}</span>
	...
	padding: 1em 0 !important;"><a href="#">金额 ：</a></h4><span class="actual">
                    ...
                    <div align="left" style="padding-top: 3%"><h4><a href="#">购买</a></h4></div>
                    <div class="clearfix"></div>
                </div>
            </div>
    ...
    <div class="login_buttons">
        <div class="check_button"><a href="orders/savecart?uid=${cartcount.uid}">确定购买</a></div>
        <div class="clearfix"></div>
    </div>
    <div class="clearfix"></div>
</div>
