...
<div class="container">
    <h2 class=" products-in" style="padding-top: 3em">订单表</h2>
    <div class="shopping_cart">
        <c:forEach items="${ordersList}" var="orderslist" >
            <div class="cart_box">
                <div class="message">
                    <%--<a href="cartdetail/deletegood?uid=${orderslist.uid}&goodsid=${orderslist.goodsid}"> <div class="alert-close"> </div></a>--%>
                    <div class="list_img"><img src=" ${orderslist.pictersrc}" class="img-responsive" alt=""></div>
                    <div style="float:left;width:40%;padding-top: 2%"><h4 style="color:#000 !important;
	font-size:12px !important;
	text-decoration:none;
	font-weight:400;
	text-transform:uppercase;
	padding: 1em 0 !important;"><a href="#">${orderslist.goodsname}</a></h4>${orderslist.num} x<span class="actual">
		                             ￥${orderslist.goodsprices}</span>

                    </div>
                    <div style="float:left;width:10%;padding-top: 2%;padding-right: 5%"><h4 style="color:#000 !important;
	font-size:12px !important;
	text-decoration:none;
	font-weight:400;
	text-transform:uppercase;
	padding: 1em 0 !important;"><a href="#">金额 ：</a></h4><span class="actual">
		                             ￥${orderslist.money}</span>
                    </div>
                    <div align="left" style="padding-top: 5%;">购买日期 ：<br /><fmt:formatDate value="${orderslist.orderstime}" pattern="yyyy年MM月dd日HH点mm分ss秒" /></div>
                    <div class="clearfix"></div>
                </div>
            </div>
        ...
        <%--<div class="cart_box">
            <div class="message1">
                ...
                <div class="list_desc"><h4><a href="#">velit esse molestie</a></h4>1 x<span class="actual">
		                             $12.00</span></div>
                <div style="padding-top: 3%"><h4><a href="#">去购买</a></h4></div>
                <div class="clearfix"></div>
            </div>
        </div>--%>
    </div>
